  ...
  return (
    <div className="text-center mb-16">
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center lg:justify-around">
        <div className="mt-10 p-8 sm:p-12 md:p-16 shadow-lg bg-hover_colr text-white w-full lg:w-[600px] flex flex-col">
          <div>
        ...
        <div className="mt-10 lg:mt-16 w-full lg:w-[500px] flex justify-center lg:justify-start">
